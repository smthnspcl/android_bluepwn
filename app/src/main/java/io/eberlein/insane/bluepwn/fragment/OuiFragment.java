...
import io.eberlein.insane.bluepwn.activity.ScanActivity;
import io.eberlein.insane.bluepwn.adapter.OuiAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ouiAdapter.setOnItemClickListener(new OuiAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int p) {
                ...
                i.putExtra("assignment", ouiAdapter.get(p).getAssignment());
                startActivity(i);
            }
        });
        return v;
